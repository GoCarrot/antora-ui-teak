...
Follow these instructions to get the credentials for sending push notifications on Android devices xref:usage:reference:page$firebase-gcm.adoc[Finding your Android Push Credentials on Firebase]
